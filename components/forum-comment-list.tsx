...
import ForumCommentForm from "./forum-comment-form"
...
export default function ForumCommentList({ comments, formatDate }: ForumCommentListProps) {
    ...
    <div className={`${isReply ? "pl-6 border-l" : "border rounded-lg"} p-4`}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          {showReplyForm && (
            <div className="mt-4">
              <ForumCommentForm postId={comment.post_id} parentId={comment.id} onSuccess={handleReplySuccess} />
            </div>
          )}
        </div>
      </div>
